...
const mobileStyles = {
  main: 'h-dvh overflow-hidden bg-[#d9d9d9] text-slate-900',
};
...
export default function HomePage() {
  ...
  return (
    <main className={styles.main}>
      <div className="mx-auto flex h-full w-full max-w-6xl flex-col rounded-[2.5rem] border-2 border-slate-700 px-4 py-4 sm:px-8 sm:py-6 lg:py-8">
